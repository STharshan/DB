...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Much more than just Tints and Wraps,i had my rear windows tinted on my car and i can safely say they did an exceptional job,I'll definitely be using them again",
    name: "Richard Benson",
  },
