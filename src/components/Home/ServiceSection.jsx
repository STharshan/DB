...
const services = [
  {
    ...
    desc: `
Reduces heat and glare, adds privacy, and protects the interior from UV damage.
`,
    image: "/carpaint.avif",
  ...
  },
  {
    ...
    desc: `Covers the vehicle with a colored or textured film to change its appearance without repainting.
​`,
    image: "/gray.avif",
  ...
  {
    title: "Remaps",
    desc: `Optimizes the engine’s software to improve power, torque, and fuel efficiency.`,
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[65%] mx-auto mt-5 h-78 object-cover"
                    onError={(e) => {
